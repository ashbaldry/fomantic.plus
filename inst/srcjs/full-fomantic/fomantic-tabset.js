var fomanticTabset = new Shiny.InputBinding();

$.extend(fomanticTabset, {
  find: function(scope) {
...
Shiny.inputBindings.register(fomanticTabset, 'shiny.fomanticTabset');

Shiny.addCustomMessageHandler('toggleFomanticNavbarTab', function(message) {
